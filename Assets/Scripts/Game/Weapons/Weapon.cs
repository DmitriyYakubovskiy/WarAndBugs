...
public class Weapon : Sound
{
    ...
    {
        if (SaveSystem.Data.SelectedItemNames["selectedGun"] != nameGun) gameObject.SetActive(false);
        if (SaveSystem.Data.SelectedItemNames["selectedGun"] == nameGun) Cursor.SetCursor(cursorTexture, new Vector2(11, 11), CursorMode.Auto);
